	...
	?>
		    ...
		    <div class="wrap">  
		        ...
		        <form name="musicdb_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">  
		            ...
		            <p><?php _e("Category Name: " ); ?><input type="text" name="musicdb_artist_name" value="<?php echo $name; ?>" size="20"><?php _e(" ex: Category One" ); ?></p>
		            <p><?php _e("Category Icon: " ); ?><input type="text" name="musicdb_artist_imageURI" value="<?php echo $imageURI; ?>" size="40"></p>
		            <p class="submit">  
		            <input type="submit" name="Submit" value="<?php _e('Add/Edit Category', 'ibotpro_musicdb' ) ?>" />  
		            </p>  
		            <p>To add another artist, simply replace the data in the fields above with the new artist data and click the "Add/Edit Category" button.</p> 
		        </form>  
		    </div>
<?php
		}
